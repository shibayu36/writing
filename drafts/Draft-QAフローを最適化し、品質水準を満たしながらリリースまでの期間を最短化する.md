...
クラスター株式会社はメタバースプラットフォームである「[cluster](https://cluster.mu/)」というサービスを一般ユーザー向けに提供しています。このサービスでは、ユーザーは3D空間へ自由に入ることができ、複数人が好きなアバターでリアルタイムに遊べます。また、その3D空間自体も[ワールドクラフト](https://creator.cluster.mu/2022/02/18/worldcraft-smartphone/)という機能やUnityを活用して、ユーザーが自由に作成しアップロードできます。
...
3. 開発チームでのQAに慣れてきたら、コード変更〜QA〜リリースまでの期間を短縮する
    - [f:id:shiba_yu36:20251110183700p:plain]
